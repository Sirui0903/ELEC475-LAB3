...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Train VGG backend with custom frontend on CIFAR-10 or CIFAR-100')
    ...
    model = Vanilla(num_classes=num_classes).to(device)
