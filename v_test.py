...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Test Vanilla VGG on CIFAR-10 or CIFAR-100')
    ...
    model = Vanilla(num_classes=100 if args.dataset_name == 'cifar100' else 10).to(device)
